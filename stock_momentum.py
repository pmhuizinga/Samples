...
nr_of_cumulative_periods = 3 # Number of periods to calculate cumulative returns
rebalance_frequency = 3 # Number of periods to rebalancing
...
#df_weight = df.copy(deep=True) # array voor gewichten
#df_weight_rebal = df.copy(deep=True) # array voor gewichten
